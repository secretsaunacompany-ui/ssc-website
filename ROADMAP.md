---
status: live
current: "Sub-page heroes LIVE on main (dd8a0d7, deployed 2026-09-07): the seven pages doc 10 §2.3 assigns a hero to -- /saunas/, /about/ and the five service-area pages -- open on a 60svh photograph with the title on a px-anchored bottom scrim. This completes the half of §2.3 that the 2026-09-03 refresh (b4974da) never built: that commit executed only the deletion corollaries (17 files, 30 deletions, nothing added) and ten pages had been opening on a black text-only band since. Relay ssc-website-sub-page-heroes, 22 commits, three critic rounds on the plan and four Razor rounds on the diff, one CRITICAL and two blocking behavioral defects found AFTER first implementation and fixed. New gate: stacking:check. Four false alts corrected. Verified live on all seven routes. On top of the hero composition C (ac4fb9a) and copy follow-ups (69328a1) trains. pricesVersion 5, models-json:roundtrip GREEN."
