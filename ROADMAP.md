...
deferred:
  - "npm-audit remediation: 70 pre-existing vulnerabilities (7 critical, 35 high; 1 high in production tree — ws via @supabase/supabase-js). Needs its own plan. Recorded 2026-07-30."
  - "Site CLS: lazy images without width/height/aspect-ratio. SCOPE RE-MEASURED 2026-08-01: 5 offenders on exactly the five service-area pages, all the same template line (src/_includes/pages/service-area.njk:15). One-line fix at one source site. Recorded 2026-07-30."
